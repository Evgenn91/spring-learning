...
<br>
<br>
<form action="/showDetails" method="get"> <%--form action - связан с кнопкой submit, тут описываем что должно произойти при нажатии кнопки(переход по адресу /showDetails)--%>
